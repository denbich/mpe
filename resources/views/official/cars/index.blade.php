...
<div class="min-height-300 bg-primary position-absolute w-100" id="background-color-div"></div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item ps-1 pt-1">
          <a class="nav-link active" href="{{ route('o.cars.index') }}">
            <i class="fa-solid fa-award text-primary text-sm opacity-10"></i>
            <span class="nav-link-text ms-1">@lang('Ładowarki elektryczne')</span>
          </a>
          </li>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card">
            <div class="card-header"><h5 class="mb-0">@lang('Lista Ładowarek')</h5></div>
                ...
                <table class="table align-items-center mb-0 text-center">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">@lang('Liczba dostępnych miejsc do ładowania')</th>
                        ...
                        <td class="text-center">
                          <div class="d-flex px-2 py-1 ms-auto">
                            <div class="d-flex flex-column justify-content-center">
                              <span class="mb-0 font-weight-bold">@lang('Ładowarka1')</span>
                              <span class="text-secondary text-xs mb-0">@lang('Ładowarka nr 1')</span>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle"><span class="badge bg-gradient-dark">{{ 5 }}</span></td>
                        <td class="align-middle text-center">
                          <a href="{{ route('o.cars.show', [1]) }}"><i class="fa-solid fa-magnifying-glass fa-lg"></i></a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-center">
                          <div class="d-flex px-2 py-1 ms-auto">
                            <div class="d-flex flex-column justify-content-center">
                              <span class="mb-0 font-weight-bold">@lang('Ładowarka2')</span>
                              <span class="text-secondary text-xs mb-0">@lang('Ładowarka nr 2')</span>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle"><span class="badge bg-gradient-dark">{{ 6 }}</span></td>
                        <td class="align-middle text-center">
                          <a href="{{ route('o.cars.show', [2]) }}"><i class="fa-solid fa-magnifying-glass fa-lg"></i></a>
                        </td>
                      </tr>
                  </tbody>
                </table>
