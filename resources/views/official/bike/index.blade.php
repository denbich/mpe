...
@section('title') @lang('Lista stacji rowerowych') @endsection
...
<div class="min-height-300 bg-primary position-absolute w-100" id="background-color-div"></div>
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card">
            <div class="card-header"><h5 class="mb-0">@lang('Lista stacji')</h5></div>
                ...
                <table class="table align-items-center mb-0 text-center">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7 ps-2">@lang('Liczba dostępnych rowerów')</th>
                        ...
                        <td class="text-center">
                          <div class="d-flex px-2 py-1 ms-auto">
                            <div class="d-flex flex-column justify-content-center">
                              <span class="mb-0 font-weight-bold">@lang('Róża')</span>
                              <span class="text-secondary text-xs mb-0">@lang('Stacja nr 1')</span>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle"><span class="badge bg-gradient-dark">{{ 3 }}</span></td>
                        <td class="align-middle text-center">
                          <a href="{{ route('o.bikes.show', [1]) }}"><i class="fa-solid fa-magnifying-glass fa-lg"></i></a>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-center">
                          <div class="d-flex px-2 py-1 ms-auto">
                            <div class="d-flex flex-column justify-content-center">
                              <span class="mb-0 font-weight-bold">@lang('Fiołek')</span>
                              <span class="text-secondary text-xs mb-0">@lang('Stacja nr 2')</span>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle"><span class="badge bg-gradient-dark">{{ 8 }}</span></td>
                        <td class="align-middle text-center">
                          <a href="{{ route('o.bikes.show', [2]) }}"><i class="fa-solid fa-magnifying-glass fa-lg"></i></a>
                        </td>
                      </tr>
                  </tbody>
                </table>
