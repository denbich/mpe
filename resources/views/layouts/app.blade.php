...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="{{ url('/assets/app/assets/css/nucleo-icons.css') }}" rel="stylesheet" />
  <link href="{{ url('assets/app/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  ...
  <script src="{{ url('/vendor/tinymce/tinymce.min.js') }}" referrerpolicy="origin"></script>
   --}}
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ url('/assets/app/css/argon-dashboard.css?v=2.0.0') }}" rel="stylesheet" />
